...
namespace IngameScript
{
    ...
    partial class Program
    {
        public partial class Z80InstructionExecutor : IZ80InstructionExecutor
        {
            ...
            // JJJ        public event EventHandler<InstructionFetchFinishedEventArgs> InstructionFetchFinished;
            ...
            private void FetchFinished(bool isRet = false, bool isHalt = false, bool isLdSp = false,
                bool isEiOrDi = false)
            {
                // JJJ            InstructionFetchFinished(this, new InstructionFetchFinishedEventArgs()
                // JJJ            {
                // JJJ                IsRetInstruction = isRet,
                // JJJ                IsHaltInstruction = isHalt,
                // JJJ                IsLdSpInstruction = isLdSp,
                // JJJ                IsEiOrDiInstruction = isEiOrDi
                // JJJ            });
            }
