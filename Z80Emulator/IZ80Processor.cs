...
namespace IngameScript
{
    partial class Program
    {
        ...
        public interface IZ80Processor
        {
            ...
            /// </summary>
            // JJJ        event EventHandler<MemoryAccessEventArgs> MemoryAccess;

            /// <summary>
            /// Pre-instruction fetch event. It is triggered before the next instruction is fetched.
            /// </summary>
            // JJJ        event EventHandler<BeforeInstructionFetchEventArgs> BeforeInstructionFetch;

            /// <summary>
            /// Pre-instruction execution event. It is triggered before an instruction is executed.
            /// </summary>
            // JJJ        event EventHandler<BeforeInstructionExecutionEventArgs> BeforeInstructionExecution;

            /// <summary>
            /// Post-instruction execution event. It is triggered after an instruction is executed.
            /// </summary>
            // JJJ        event EventHandler<AfterInstructionExecutionEventArgs> AfterInstructionExecution;
