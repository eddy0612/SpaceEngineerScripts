namespace IngameScript
{
    partial class Program
    {
        ...
        public interface IExecutionStopper
        {
            ...
            /// processor classs will return <see cref="IngameScript.StopReason.PauseInvoked"/> after the method returns.
            /// If <b>false</b>, it will return <see cref="IngameScript.StopReason.StopInvoked"/>.</param>
