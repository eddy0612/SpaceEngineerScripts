...
namespace IngameScript
{
    partial class Program
    {
        ...
        public class Z80Processor : IZ80Processor, IZ80ProcessorAgent
        {
            ...
            {
                /*JJJ            AfterInstructionExecution?.Invoke(this, new AfterInstructionExecutionEventArgs(
            ...
            public void RegisterInterruptSource(IZ80InterruptSource source)
            {
                ...
                // JJJ            source.NmiInterruptPulse += (sender, args) => NmiInterruptPending = true;
            }
            ...
            {
                // JJJ            foreach(var source in InterruptSources) {
                // JJJ                source.NmiInterruptPulse -= (sender, args) => NmiInterruptPending = true;
                // JJJ            }
            ...
            public IZ80InstructionExecutor InstructionExecutor
            {
                ...
                set
                {
                    ...
                    // JJJ                if(_InstructionExecutor != null)
                    // JJJ                    _InstructionExecutor.InstructionFetchFinished -= InstructionExecutor_InstructionFetchFinished;
            ...
            // JJJ public event EventHandler<MemoryAccessEventArgs> MemoryAccess;

            // JJJ public event EventHandler<BeforeInstructionFetchEventArgs> BeforeInstructionFetch;

            // JJJ public event EventHandler<BeforeInstructionExecutionEventArgs> BeforeInstructionExecution;

            // JJJ public event EventHandler<AfterInstructionExecutionEventArgs> AfterInstructionExecution;
                ...
                bool cancelMemoryAccess = false)
            {
                ...
                //JJJ            MemoryAccess?.Invoke(this, eventArgs);
                return eventArgs;
            }
